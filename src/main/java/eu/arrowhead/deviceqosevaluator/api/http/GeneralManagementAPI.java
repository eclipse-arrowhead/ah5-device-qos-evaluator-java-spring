...
@RestController
@RequestMapping(DeviceQoSEvaluatorConstants.HTTP_API_GENERAL_MANAGEMENT_PATH)
...
public class GeneralManagementAPI {
	...
	public @ResponseBody LogEntryListResponseDTO getLogEntries(@RequestBody(required = false) final LogRequestDTO dto) {
		...
		final String origin = HttpMethod.POST.name() + " " + DeviceQoSEvaluatorConstants.HTTP_API_GENERAL_MANAGEMENT_PATH + Constants.HTTP_API_OP_LOGS_PATH;
	...
	public KeyValuesDTO getConfig(final @RequestParam(required = false, name = Constants.SERVICE_OP_GET_CONFIG_REQ_PARAM) List<String> keys) {
		...
		final String origin = HttpMethod.GET.name() + " " + DeviceQoSEvaluatorConstants.HTTP_API_GENERAL_MANAGEMENT_PATH + Constants.HTTP_API_OP_GET_CONFIG_PATH;
