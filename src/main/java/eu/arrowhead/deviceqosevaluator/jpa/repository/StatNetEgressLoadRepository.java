...
@Repository
public interface StatNetEgressLoadRepository extends RefreshableRepository<StatNetEgressLoad, Long> {

	//=================================================================================================
	// methods

	//-------------------------------------------------------------------------------------------------
	public Page<StatNetEgressLoad> findAllByIdIn(final Collection<Long> ids, final Pageable pageable);
